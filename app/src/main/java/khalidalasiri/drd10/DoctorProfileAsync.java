...
class DoctorProfileAsync extends AsyncTask<String, Void, String[]> {
    ...
    public DoctorProfileAsync(List<HttpCookie> token, Context context, String tableURL, String tableName) {
        this.token = token;
    ...
    protected String[] doInBackground(String... strings) {
        ...
        try {
            ...
            String include= "&include=User_Address,Identification_Number,Doctor";
            ...
            if (records.isNull(0)) {
                ...
                JSONObject Doctor = root.getJSONObject("Doctor");
                JSONArray records3 = Doctor.getJSONArray("records");

                if (!records3.isNull(0)) {
                    result[17] = records3.getJSONArray(0).get(2).toString() ; // The Rank
                    result[18] = records3.getJSONArray(0).get(3).toString() ; // The Degree
                }
                return result;
            }
